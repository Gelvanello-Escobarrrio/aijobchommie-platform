/**
 *  DATABASE SCHEMA MODELS (API canonical copy)
 *
 *  Ported from apps/web to provide a single source of truth for the API package.
 */

import { pgTable, varchar, text, timestamp, boolean, integer, decimal, jsonb, uuid } from 'drizzle-orm/pg-core';
